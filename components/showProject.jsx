...
const images=[{id:1,src:'/music.jpg',href:'https://music-app-reem-hasans-projects-9ab23a8b.vercel.app/',url:'https://github.com/Reem-del/musicApp',active:'one'},{id:2,src:'/quiz.jpg',href:'https://quiz-ffytyzcjj-reem-hasans-projects-9ab23a8b.vercel.app/',active:'two',url:'https://github.com/Reem-del/Quiz'},
{id:3,src:'/e-commerce.jpg',href:'https://shop-reem-del-reem-hasans-projects-9ab23a8b.vercel.app/',active:'three',url:'https://github.com/Reem-del/e-commerce'},
{id:4,src:'/blog.jpg',href:'https://blogee-gamma.vercel.app/',active:'foue',url:'https://github.com/Reem-del/blogee'}]
  ...
  return (
     <div className='h-[400px] w-full text-slate-200  hover:text-yellow-200 max-[430px]:h-[700px]'>
      <div className='flex flex-row  gap-2 ml-7 p-4 '>
        ...
        <ul ref={ref} className='flex flex-row flex-wrap gap-4 justify-center w-full h-64 max-[350px]:gap-6 '>
